...
export function leerSuperheroes(ruta){
    ...
    superheroes.sort((a, b) => a.nombreSuperheroe.localeCompare(b.nombreSuperheroe)); //superheroes.sort((a, b) => a.id - b.id); si el parametro es un numero, no lleva el metodo localeCompare
    return superheroes;
}
